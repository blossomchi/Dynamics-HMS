<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_y51une2f" %>
                                  ...
                                  <table runat="server" align="center"  cellpadding="5" cellspacing="5" class="auto-style1" style="background-color: #FFFFFF">
                                      ...
                                      <tr>
                                          ...
                                          <td class="auto-style5">
                                              <asp:CheckBox ID="chk_HMO" runat="server" AutoPostBack="True" CssClass="auto-style24" />
                                          </td>
                                          <td class="auto-style24"><strong>HMO</strong></td>
                                      </tr>
                                      <tr>
         ...
         <tr >
             <td class="auto-style9" style="position: absolute; top: 65px; text-align: left;" colspan="6"   >
                  ...
                  <table runat="server"  align="center" class="auto-style47" style="margin-top:0px; width: 1186px;" id="PrivateTable" visible="False">
                                    <tr>
                                        <td class="auto-style15" colspan="4" style="border-top-style:solid; border-top-color:white; border-top-right-radius:10px; border-top-left-radius:10px; text-align: center; font-weight: 700;">HMO<hr style="height: -12px" />
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <asp:TextBox ID="txtMname_Preg" runat="server" TabIndex="2"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_Sex_Preg" runat="server" TabIndex="3" required="true">
                        ...
                        <asp:ListItem>Female</asp:ListItem>
                                                ...
                                                <ContentTemplate>
                                                    <table class="auto-style67">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtAge_Preg" runat="server" ReadOnly="True" required="true" TabIndex="7"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_Religion_Preg" runat="server" TabIndex="8" required="true">
                    ...
                    <asp:TextBox ID="txtHomeAdress_Preg" runat="server" TextMode="MultiLine" TabIndex="13"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPhoneNo_Preg" runat="server" TabIndex="14" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPhoneNo_PregAlternate" runat="server" TabIndex="14" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_MatitalStatus_Preg" runat="server" TabIndex="15" required="true">
                    ...
                    <asp:DropDownList ID="DList_BloodGroup_Preg" runat="server" TabIndex="17">
                        ...
                        <asp:ListItem>O -v</asp:ListItem>
                                    ...
                                    <tr>
                                        <td class="auto-style15" colspan="4">
                                            <strong>HELATH INSURANCE INFORMATION COLLATION</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Insurance Company</td>
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_InsuranceCom_Preg" runat="server" TabIndex="18">
                        <asp:ListItem>MANSARD INSURANCE</asp:ListItem>
                        <asp:ListItem>AIICO</asp:ListItem>
                        <asp:ListItem>FBN INSURANCE</asp:ListItem>
                        <asp:ListItem>CUSTODIAN INSURANCE PLC</asp:ListItem>
                        <asp:ListItem>LEADWAY INSURANCE</asp:ListItem>
                        <asp:ListItem>IGI INSURANCE</asp:ListItem>
                        <asp:ListItem Value="LEADWAY INSURANCE PLC"></asp:ListItem>
                        <asp:ListItem>NEM INSURANCE</asp:ListItem>
                        <asp:ListItem>MUTUAL ASSURANCE PLC</asp:ListItem>
                        <asp:ListItem>ZENITH INSURANCE</asp:ListItem>
                        <asp:ListItem>STACO INSURANCE PLC</asp:ListItem>
                        <asp:ListItem>GEICO INSURANCE</asp:ListItem>
                        <asp:ListItem>FIN INSURANCE COMPANY LIMITED</asp:ListItem>
                        <asp:ListItem>GOLDLINK INSURANCE</asp:ListItem>
                        <asp:ListItem>CONSOLIDATED HALLMARK INSURANCE</asp:ListItem>
                        <asp:ListItem>NIGER INSURANCE PLC</asp:ListItem>
                    </asp:DropDownList>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Insurance ID No.</td>
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtInsuranceID_Preg" runat="server" TabIndex="19"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Insurance Group No.</td>
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtInsuranceGroupNO_Preg" runat="server" TabIndex="20"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Policy No.</td>
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtInsurancePolicy_Preg" runat="server" TabIndex="21"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Policy Holder&#39;s Name</td>
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtInsurancePolicyHolder_Preg" runat="server" TabIndex="22"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPGuadianFullname_Preg" runat="server" TabIndex="23" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPGuadianMobile_Preg" runat="server" TabIndex="24" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                    ...
                    <asp:DropDownList ID="DList_Guardian_Preg" runat="server" TabIndex="25" required="true">
                    ...
                    <asp:TextBox ID="txtPGuadianAddress_Preg" runat="server" TextMode="MultiLine" TabIndex="26"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtNOKFname_Preg" runat="server" TabIndex="27" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtNOKMobileNO_Preg" runat="server" TabIndex="28" required="true"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                    ...
                    <asp:DropDownList ID="DList_NOKRelation_Preg" runat="server" TabIndex="29" required="true">
                        <asp:ListItem>Aunt</asp:ListItem>
                        <asp:ListItem>Brother</asp:ListItem>
                    ...
                    <asp:TextBox ID="txtNOKAddress_Preg" runat="server" TextMode="MultiLine" TabIndex="30"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:Button ID="btn_Submit_Preg" runat="server" Text="SUBMIT" TabIndex="31" />
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                </table>
