<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_z2imwg43" %>
                              ...
                              <fieldset runat="server" align="center" style="width:600px" id="FileTypeFedSet">
                                  ...
                                  <table runat="server" align="center"  cellpadding="5" cellspacing="5" class="auto-style1" style="background-color: #FFFFFF">
                                      ...
                                      <tr>
                                          ...
                                          <td class="auto-style9"></span><strong><span class="auto-style24">FAMILY</span></strong></td>
                                      </tr>
                                      <tr>
         ...
         <tr >
             <td class="auto-style9" style="position: absolute; top: 65px; text-align: left;" colspan="6"   >
                  ...
                  <table runat="server"  align="center" class="auto-style47" style="margin-top:0px; width: 1186px;" id="PrivateTable" visible="False">
                                    <tr>
                                        <td class="auto-style15" colspan="4" style="border-top-style:solid; border-top-color:white; border-top-right-radius:10px; border-top-left-radius:10px; text-align: center; font-weight: 700;">FAMILY FILE<hr style="height: -12px" />
                                        </td>
                                    </tr>
                                    <tr>
...
&nbsp;&nbsp; </strong>
                                            <asp:DropDownList ID="CBFamilyName" runat="server" class="chosen-select" AutoPostBack="True" DataSourceID="FamilyDS" DataTextField="Family Name" DataValueField="FamilyID" Width="200px">
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="FamilyDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT FamilyID, FamilyName + ' ' + FamilyFirstName AS [Family Name] FROM tbl_Family"></asp:SqlDataSource>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                    ...
                    <asp:Button ID="btn_Submit_Preg" runat="server" Text="SUBMIT" TabIndex="31" />
                                            <asp:TextBox ID="txtFamilyID" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                </table>
