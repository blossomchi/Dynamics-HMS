<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_iji5prik" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" style="width: 303px; height: auto; clip: rect(0px, 303px, 1682px, 0px);"><!--<![endif]-->
 <span class="xr_s0" style="position: absolute; left:-166px; top:31px;">
  <span class="xr_tc" style="left: 199px; top: -22px; width: 226px;"><span class="xr_s1">SHERPHERD HOSPITAL</span></span>
  <span class="xr_tc" style="left: 311px; top: 6px; width: 6px;">&nbsp;</span>
 </span>
 <span class="xr_s2" style="position: absolute; left:-157px; top:92px;">
  <span class="xr_tc" style="left: 184px; top: -14px; width: 256px;">Website: www.sherpherdhospital.com</span>
 </span>
                        ...
                        <table id="ReceiptHeaderTable" runat="server" visible="True" 
                            ...
                            <tr>
                                <td class="style46" >
                                 ...
                                 <asp:Label ID="LBFileName" runat="server">File Type :</asp:Label>
                                ...
                                <td class="style43"  >
                                 ...
                                 <asp:Label ID="LBFT" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td >
                                 ...
                                 <asp:Label ID="LBPatientnName" runat="server">Patient Name :</asp:Label>
                                ...
                                <td class="style43" >
                                 ...
                                 <asp:Label ID="LBPatientFullName" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td class="style43" >
                                 ...
                                 <asp:Label ID="LBCommentPatient" runat="server">Comment:</asp:Label>
                                ...
                                <td class="style41" >
                                 ...
                                 <asp:Label ID="LBPatientComment" runat="server"></asp:Label>
                            ...
                            <tr>
                                <td class="style45" colspan="2" >
                                 ...
                                 <asp:Label ID="LBCmment" runat="server"></asp:Label>
