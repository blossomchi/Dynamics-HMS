<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_khz0bzkz" %>
                              ...
                              <fieldset runat="server" align="center" style="width:600px" id="FileTypeFedSet">
                                  ...
                                  <table runat="server" align="center"  cellpadding="5" cellspacing="5" class="auto-style1" style="background-color: #FFFFFF">
                                      ...
                                      <tr>
                                          ...
                                          <td class="auto-style9"></span><strong><span class="auto-style24">DIRECT COMPANY</span></strong></td>
                                      </tr>
                                      <tr>
         ...
         <tr >
             <td class="auto-style9" style="position: absolute; top: 65px; text-align: left;" colspan="6"   >
                  ...
                  <table runat="server"  align="center" class="auto-style47" style="margin-top:0px; width: 1186px;" id="PrivateTable" visible="False">
                                    <tr>
                                        <td class="auto-style15" colspan="4" style="border-top-style:solid; border-top-color:white; border-top-right-radius:10px; border-top-left-radius:10px; text-align: center; font-weight: 700;">DIRECT COMPANY<hr style="height: -12px" />
                                        </td>
                                    </tr>
                                    <tr>
