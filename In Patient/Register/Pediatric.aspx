<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_iji5prik" %>
...
<body style="background-color: #F5F5F1">
 ...
 <img class="auto-style23" src="login_htm_files/31.png" alt="" title=""/>
                                  ...
                                  <table runat="server" align="center"  cellpadding="5" cellspacing="5" class="auto-style1" style="background-color: #FFFFFF">
                                      ...
                                      <tr>
                                          ...
                                          <td class="auto-style5">
                                              <asp:CheckBox ID="chk_Children" runat="server" AutoPostBack="True" CssClass="auto-style25" />
                                          </td>
                                          <td class="auto-style25"><strong>CHILDREN</strong></td>
                                      </tr>
                                      <tr>
         ...
         <tr >
             <td class="auto-style9" style="position: absolute; top: 65px; text-align: left;" colspan="6"   >
                  ...
                  <table runat="server"  align="center" class="auto-style47" style="margin-top:0px; width: 1186px;" id="PrivateTable" visible="False">
                                    <tr>
                                        <td class="auto-style15" colspan="4" style="border-top-style:solid; border-top-color:white; border-top-right-radius:10px; border-top-left-radius:10px; text-align: center; font-weight: 700;">PEDIATRIC<hr style="height: -12px" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtSname_Preg" runat="server" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtFname_Preg" runat="server" TabIndex="1" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtMname_Preg" runat="server" TabIndex="2" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_Sex_Preg" runat="server" TabIndex="3" required="true" Width="350px">
                        ...
                        <asp:ListItem>Female</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_Religion_Preg" runat="server" TabIndex="8" required="true" Width="350px">
                        ...
                        <asp:ListItem>Others</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtOccupation_Preg" runat="server" TabIndex="9" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtNationality_Preg" runat="server" TabIndex="10" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPOO_Preg" runat="server" TabIndex="11" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPOB_Preg" runat="server" TabIndex="12" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtHomeAdress_Preg" runat="server" TextMode="MultiLine" TabIndex="13" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtPhoneNo_Preg" runat="server" TabIndex="14" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_Genotype_Preg" runat="server" TabIndex="16" Width="350px">
                        ...
                        <asp:ListItem>SS</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:DropDownList ID="DList_BloodGroup_Preg" runat="server" TabIndex="17" Width="350px">
                        ...
                        <asp:ListItem>O -v</asp:ListItem>
                                    ...
                                    <tr>
                                        <td class="auto-style15" colspan="4"><strong>PARENT INFORMATION COLLATION</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Father&#39;s Name</td>
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtFatherName" runat="server" TabIndex="27" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style63">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtFatherMobileNO" runat="server" TabIndex="28" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtFatherAddress" runat="server" TextMode="MultiLine" TabIndex="30" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Mother&#39;s Name</td>
                                        <td class="auto-style69">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtMotherName" runat="server" TabIndex="27" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style57">Mobile Phone</td>
                                        <td class="auto-style69">
                                            <strong>*</strong></td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtMotherMobileNO" runat="server" TabIndex="28" required="true" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="auto-style69">
                                            &nbsp;</td>
                                        <td class="auto-style48">
                    <asp:TextBox ID="txtMotherAddress" runat="server" TextMode="MultiLine" TabIndex="30" Width="350px"></asp:TextBox>
                                        </td>
                                        <td class="auto-style48">&nbsp;</td>
                                    </tr>
                                    <tr>
