<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_dgxqlbdo" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="BILLING"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td>
                        ...
                        <tr>
                            <td class="auto-style19">Department</td>
                            <td class="auto-style26">
                    <asp:DropDownList ID="DlistIndvidual" runat="server" class="chosen-select" DataSourceID="SqlDataSource2" DataTextField="DeptName" DataValueField="DeptCode" Width="200px" AutoPostBack="True" Visible="False">
                    </asp:DropDownList>
                    <asp:DropDownList ID="DlistADMIN" runat="server" class="chosen-select" DataSourceID="ALLDS" DataTextField="DeptName" DataValueField="DeptCode" Width="200px" AutoPostBack="True" Visible="False">
                    </asp:DropDownList>
                            </td>
                            <td class="auto-style18">
                                <asp:TextBox ID="DepCode" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                          <asp:TextBox ID="PassCode" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                          <asp:TextBox ID="Code" runat="server" Visible="False" Width="20px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td class="auto-style19">Billing</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="BillName" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style26">
                    <asp:TextBox ID="Amount" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">&nbsp;</td>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                <asp:GridView ID="IndividualGV" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="SqlDataSource1" GridLines="Vertical" ShowFooter="True" style="font-size: 12px" Width="1206px" Visible="False">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                                        <asp:BoundField DataField="DeptName" HeaderText="Department" SortExpression="DeptName" />
                                        <asp:BoundField DataField="BillName" HeaderText="Billing" SortExpression="BillName" />
                                ...
                                <asp:GridView ID="AdminGV" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="SqlDataSource3" GridLines="Vertical" ShowFooter="True" style="font-size: 12px" Width="1206px" Visible="False">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                                        <asp:BoundField DataField="DeptName" HeaderText="Department" SortExpression="DeptName" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT Billing.ID, Department_tbl.DeptName, Billing.BillName, Billing.Amount, Billing.DateCreated FROM Department_tbl INNER JOIN Billing ON Department_tbl.DeptCode = Billing.DeptCode"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT Billing.ID, Department_tbl.DeptName, Billing.BillName, Billing.Amount, Billing.DateCreated FROM Department_tbl INNER JOIN Billing ON Department_tbl.DeptCode = Billing.DeptCode WHERE (Department_tbl.DeptCode = @DepCode)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="PassCode" Name="DepCode" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:SqlDataSource ID="ALLDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SN, DeptCode, DeptName FROM Department_tbl"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SN, DeptCode, DeptName FROM Department_tbl WHERE (DeptCode = @Dept)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="DepCode" Name="Dept" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </td>
                        </tr>
