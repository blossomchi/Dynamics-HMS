<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_sdsua4kq" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" >
                      <tr>
                          <td colspan="6">
                              ...
                              <strong><span class="auto-style11">PATIENT DASHBOARD</span><hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton1" runat="server" Height="123px" ImageUrl="~/In Patient/images/personal.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton10" runat="server" Height="123px" ImageUrl="~/In Patient/images/pediatric.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton11" runat="server" Height="123px" ImageUrl="~/In Patient/images/antinatal.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton12" runat="server" Height="123px" ImageUrl="~/In Patient/images/hmo.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton13" runat="server" Height="123px" ImageUrl="~/In Patient/images/direct company.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton14" runat="server" Height="123px" ImageUrl="~/In Patient/images/staff.png" Width="144px" ToolTip="Register In Patient" />
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton15" runat="server" Height="123px" ImageUrl="~/In Patient/images/others.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton16" runat="server" Height="123px" ImageUrl="~/In Patient/images/family.png" Width="144px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton3" runat="server" Height="111px" ImageUrl="~/In Patient/Register/images/j.jpeg" Width="134px" ToolTip="Pre-Examination Test" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton17" runat="server" Height="109px" ImageUrl="~/In Patient/images/Patient with doctors 4.png" Width="144px" ToolTip="Book patient to see a doctor" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton8" runat="server" Height="105px" ImageUrl="~/In Patient/Register/images/b1.jpeg" Width="134px" ToolTip="Hospital Billing" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton5" runat="server" Height="112px" ImageUrl="~/In Patient/Register/images/cccc.jpeg" Width="127px" />
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton4" runat="server" Height="97px" ImageUrl="~/In Patient/Register/images/bed.png" Width="130px" />
                          ...
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton9" runat="server" Height="103px" ImageUrl="~/In Patient/images/patient with doctors 1.jpg" Width="140px" ToolTip="Book patient to see a doctor" Visible="False" />
