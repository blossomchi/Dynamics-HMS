<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_mzdj1r2j" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="CONSULTATION"></asp:Label>
                          </td>
                      </tr>
                      <tr>
