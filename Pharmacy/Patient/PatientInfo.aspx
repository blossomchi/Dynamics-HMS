<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_ac5povlu" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="VIEW PATIENT INFORMATION"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
                  
                              <asp:TextBox ID="txtName" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                <asp:Button ID="HomeBTN" runat="server" Text="DASH BOARD" />
                  
                                <asp:DropDownList ID="CBSearch" runat="server" class="chosen-select" DataSourceID="PatientDS" DataTextField="Surname" DataValueField="Surname" Width="350px" AutoPostBack="True">
                                </asp:DropDownList>
                  
                    <asp:Button ID="RegisterID" runat="server" Text="SEARCH" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="PatientID" DataSourceID="ViewAll" GridLines="None" PageSize="30" ShowFooter="True" Width="1208px">
                  ...
                  <asp:GridView ID="ViewSearchRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="PatientID" DataSourceID="SearchDS" GridLines="None" PageSize="5" ShowFooter="True" Width="1208px" Visible="False">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="PatientID" HeaderText="Patient ID" ReadOnly="True" SortExpression="PatientID" />
                          <asp:BoundField DataField="Description" HeaderText="File Type" SortExpression="Description" />
                      ...
                      <SortedDescendingHeaderStyle BackColor="#000065" />
                              ...
                              <asp:SqlDataSource ID="SearchDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT RegistrationHeader_tbl.PatientID, File_Type_tbl.Description, RegistrationHeader_tbl.Surname + ' ' + RegistrationHeader_tbl.Firstname + ' ' + RegistrationHeader_tbl.Middlename AS [Patient Name], RegistrationHeader_tbl.MobileNo, RegistrationHeader_tbl.DateCreated FROM RegistrationHeader_tbl INNER JOIN File_Type_tbl ON RegistrationHeader_tbl.FileTypeTB = File_Type_tbl.SN WHERE (RegistrationHeader_tbl.Surname = @LastName)">
                                  <SelectParameters>
                                      <asp:ControlParameter ControlID="txtName" Name="LastName" PropertyName="Text" />
                                  </SelectParameters>
                              </asp:SqlDataSource>
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT RegistrationHeader_tbl.PatientID, File_Type_tbl.Description, RegistrationHeader_tbl.Surname + ' ' + RegistrationHeader_tbl.Firstname + ' ' + RegistrationHeader_tbl.Middlename AS [Patient Name], RegistrationHeader_tbl.MobileNo, RegistrationHeader_tbl.DateCreated FROM RegistrationHeader_tbl INNER JOIN File_Type_tbl ON RegistrationHeader_tbl.FileTypeTB = File_Type_tbl.SN"></asp:SqlDataSource>
         

                              <asp:SqlDataSource ID="PatientDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT Surname FROM RegistrationHeader_tbl GROUP BY Surname"></asp:SqlDataSource>
