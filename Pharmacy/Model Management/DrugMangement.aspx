<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_bmyxdbsb" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="DRUG MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          ...
                          &nbsp;<asp:Button ID="RegisterID" runat="server" Text="CREATE DRUG" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ViewAll" GridLines="None" PageSize="30" ShowFooter="True" Width="1208px">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="DrugBarcode" HeaderText="Drug Barcode" SortExpression="DrugBarcode" />
                     ...
                     <asp:TemplateField>
                                      ...
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/Employee/images/good.png" Text="Select" ToolTip="Edit"/>
                                  </ItemTemplate>
                                     </asp:TemplateField>
                          </Columns>
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugItemDescriptionTable.DrugBarcode, DrugItemDescriptionTable.DrugFulldescription, Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.Surname AS Staff, DrugItemDescriptionTable.dateCreated FROM Employee_New_tbl INNER JOIN DrugItemDescriptionTable ON Employee_New_tbl.EmployeeCode = DrugItemDescriptionTable.CreatedBy"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">
                                <asp:CheckBox ID="CheckHasBarcode" runat="server" Text="Has Barcode" AutoPostBack="True" />
                            </td>
                            <td class="auto-style26">
                    <asp:TextBox ID="BarcodeTextBox" runat="server" Width="400px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td class="auto-style26" rowspan="7">
                                <strong>
                                <asp:Image ID="imgBarcode" runat="server" ToolTip="Barcode" Visible="False" />
                                </strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Product Group</td>
                            <td class="auto-style26">
                                              <asp:DropDownList ID="CBProduct" runat="server" class="chosen-select" AutoPostBack="True" DataSourceID="productFS" DataTextField="ProductCatName" DataValueField="PCatID" Width="400px">
                                              </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Manufacturer</td>
                            <td class="auto-style26">
                                              <asp:DropDownList ID="CBManu" runat="server" class="chosen-select" AutoPostBack="True" DataSourceID="ManuDS" DataTextField="ManuName" DataValueField="ManuID" Width="400px">
                                              </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Classes</td>
                            <td class="auto-style26">
                                              <asp:DropDownList ID="CBClasses" runat="server" class="chosen-select" AutoPostBack="True" DataSourceID="ClassDS" DataTextField="DrugName" DataValueField="DrugID" Width="400px">
                                              </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Code</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugItemID" runat="server" Width="400px" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Drug Name</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugName" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Product Number</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtProductNO" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">&nbsp;</td>
                            <td class="auto-style26" colspan="2">
                                <strong><asp:CheckBox ID="ChkBatchNo" runat="server" Enabled="False" Text="Batch No" />
                                <asp:CheckBox ID="ChkExpiringDate" runat="server" Enabled="False" Text="Expiring Date" />
                                <asp:CheckBox ID="ChkManuDate" runat="server" Enabled="False" Text="Manufacturing Date" />
                                <asp:CheckBox ID="ChkNafdac" runat="server" Enabled="False" Text="NAFDAC No" />
                                <asp:CheckBox ID="ChkSerialNoNo" runat="server" Enabled="False" Text="Serial No" />
                                </strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Inventory Order</td>
                            <td class="auto-style26" colspan="2">
                                <asp:DropDownList ID="CBInventoryMethod" runat="server" class="chosen-select" DataSourceID="InventoryMethod" DataTextField="InventoryMethod" DataValueField="InventoryMethod" Height="16px" style="text-align: left" Width="400px" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19" style="vertical-align: top">Dosage</td>
                            <td class="auto-style26" colspan="2">
                    <asp:TextBox ID="txtDosage" runat="server" Width="400px" Height="200px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">&nbsp;</td>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="3">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="DrugBarcode" HeaderText="Barcode" SortExpression="DrugBarcode" />
                                        <asp:BoundField DataField="DrugFulldescription" HeaderText="Drug Full Description" SortExpression="DrugFulldescription" />
                                        <asp:BoundField DataField="dateCreated" HeaderText="Date Created" SortExpression="dateCreated" />
                                  <asp:TemplateField>
                                          <ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugItemDescriptionTable.DrugBarcode, DrugItemDescriptionTable.DrugFulldescription, Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.Surname AS Staff, DrugItemDescriptionTable.dateCreated FROM Employee_New_tbl INNER JOIN DrugItemDescriptionTable ON Employee_New_tbl.EmployeeCode = DrugItemDescriptionTable.CreatedBy"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="productFS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT [PCatID], [ProductCatName] FROM [ProductCatTable]"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="ManuDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT PCatID, ManuID, ManuName FROM ManufacturerTable WHERE (PCatID = @PID)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="PCID" Name="PID" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:SqlDataSource ID="ClassDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugID, DrugName FROM DrugClassHeadTable"></asp:SqlDataSource>
                                <strong>
                                <asp:SqlDataSource ID="InventoryMethod" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT [ID], [InventoryMethod] FROM [InventoryMethodTable]"></asp:SqlDataSource>
                                </strong>
                            </td>
                        </tr>
                        </table></td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          ...
                                          <asp:TextBox ID="PCID" runat="server" Visible="False" Width="20px"></asp:TextBox>
