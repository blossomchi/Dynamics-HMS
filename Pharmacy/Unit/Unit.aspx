<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_upuqe0wr" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="PRODUCT UNIT DETAILS"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                    ...
                    <asp:Button ID="RegisterID" runat="server" Text="ADD BASED UNIT" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="SN" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                          <asp:BoundField DataField="UnitSymbol" HeaderText="Unit Symbol" SortExpression="UnitSymbol" />
                          <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
                          <asp:BoundField DataField="UnitDecimalPlaces" HeaderText="Unit Decimal Places" SortExpression="UnitDecimalPlaces" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT UnitMeasurmentTable.SN, UnitMeasurmentTable.UnitSymbol, UnitMeasurmentTable.Name, UnitMeasurmentTable.UnitDecimalPlaces, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS Staff, UnitMeasurmentTable.DateCreated FROM UnitMeasurmentTable INNER JOIN Employee_New_tbl ON UnitMeasurmentTable.CreatedBy = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
                      ...
                      <tr>
                          <td>
                              ...
                              <table id="AETB1" runat="server" visible="false" cellpadding="0" cellspacing="0" class="auto-style21" style="border-width: 1px; border-style: solid;  border-top-left-radius:20px; border-top-right-radius:20px; background-color: white; font-size: 15px;">
                                  <tr>
                        ...
                        <tr>
                            <td colspan="5">
                                <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Underline="True" Text="ENTER UNIT OF MEASURMENT"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Unit Symbol</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtUnitCode" runat="server" Width="200px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td class="auto-style19">Unit Name</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtUnitName" runat="server" Width="200px"></asp:TextBox>
                        ...
                        <tr>
                            <td class="auto-style19">Decimal Places</td>
                            <td class="auto-style26" colspan="2">
                    <asp:TextBox ID="txtDecimal" runat="server" Width="200px"></asp:TextBox>
                            </td>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="SN" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT UnitMeasurmentTable.SN, UnitMeasurmentTable.UnitSymbol, UnitMeasurmentTable.Name, UnitMeasurmentTable.UnitDecimalPlaces, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS Staff, UnitMeasurmentTable.DateCreated FROM UnitMeasurmentTable INNER JOIN Employee_New_tbl ON UnitMeasurmentTable.CreatedBy = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
                            </td>
                        </tr>
                        </table></td>
                                  </tr>
