<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_4ii2hf50" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="DOCUMENT ENTRY"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                    ...
                    <asp:Button ID="RegisterID" runat="server" Text="CONSULT" TabIndex="31" />
