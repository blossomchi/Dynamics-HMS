<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_jmldwcu5" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             ...
             <td class="auto-style9" style="position: absolute; top: 40px; text-align: right;"   >
                    ...
                    &nbsp;</td></tr>
         <tr >
             <td class="auto-style9" style="text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="STOCK MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                    ...
                    <asp:Button ID="RegisterID0" runat="server" Text="STOCK LOCATION" TabIndex="31" />
                 
                    <asp:Button ID="RegisterID" runat="server" Text="ADD STOCK" TabIndex="31" />
         ...
         <asp:Panel ID="ModalPanel" runat="server">
           ...
           <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="PanelAFDBreakdown" BackgroundCssClass="modalBackground" CancelControlID="ImageClose" DropShadow="True" TargetControlID="lnkDummy">
             ...
             <%-- end of popup information --%>
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ConsultID" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                          <asp:BoundField DataField="ConsultID" HeaderText="Consult ID" ReadOnly="True" SortExpression="ConsultID" />
                          ...
                          <asp:BoundField DataField="Description" HeaderText="Wrong" SortExpression="Description" />
                          <asp:BoundField DataField="Purpose" HeaderText="Purpose" SortExpression="Purpose" />
                          <asp:BoundField DataField="ConsultDateTime" HeaderText="Consult Date Time" SortExpression="ConsultDateTime" />
                      </Columns>
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SN, ConsultID, PatientID, PatientName, Doctor, Purpose, Description, ConsultDateTime FROM tbl_Consultation"></asp:SqlDataSource>
                      ...
                      <tr>
                          <td>
                                          ...
                                          <table id="StockLocationTable" runat="server" align="center" style="border-style: solid; border-width: medium; width: 610px; background-color: #FFFFFF;" visible="False">
                                              <tr>
                                                  <td class="style74" colspan="2" valign="top">
                                                      <br />
                                                      <strong><span class="style87">Stock Location......</span></strong></td>
                                                  <td align="left" class="style73" rowspan="4" valign="top">
                                                      <asp:GridView ID="StoreLocationGV" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="wholesaleds" ForeColor="#333333" GridLines="None" Height="132px" PageSize="9" Width="224px" DataKeyNames="StockLocationID">
                                                          <AlternatingRowStyle BackColor="White" />
                                                          <Columns>
                                                              <asp:BoundField DataField="StockLocationID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="StockLocationID" />
                                                            ...
                                                            <asp:TemplateField ShowHeader="False">
                                                              ...
                                                              <asp:TemplateField ShowHeader="False">
                                                                  <ItemTemplate>
                                                                      <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("StockLocationID") %>' CommandName="DeleteItem" ImageUrl="~/images/del.png" Text="Delete" Tooltip="Delete" />
                                                                  </ItemTemplate>
                                                              </asp:TemplateField>
                                                              </Columns>
                                                      ...
                                                      <asp:GridView ID="SearchStoreLocationGV" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="wholesaleSearchds" ForeColor="#333333" GridLines="None" Height="132px" PageSize="2" Visible="False" Width="224px" DataKeyNames="StockLocationID">
                                                          <AlternatingRowStyle BackColor="White" />
                                                          <Columns>
                                                              <asp:BoundField DataField="StockLocationID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="StockLocationID" />
                                                              <asp:BoundField DataField="BranchLocation" HeaderText="Branch" SortExpression="BranchLocation" />
                                                              ...
                                                              <asp:TemplateField ShowHeader="False">
                                                                  <ItemTemplate>
                                                                      <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="False" CommandName="Select" ImageUrl="~/Pharmacy/Purchase Request/images/edit.png" Text="Select" ToolTip="Edit" />
                                                                  </ItemTemplate>
                                                              </asp:TemplateField>
                                                              <asp:TemplateField ShowHeader="False">
                                                                  <ItemTemplate>
                                                                      <asp:ImageButton ID="ImageButton6" runat="server" CausesValidation="false" CommandArgument='<%#Eval("StockLocationID") %>' CommandName="DeleteItem" ImageUrl="~/images/del.png" Text="Delete" Tooltip="Delete" />
                                                                  </ItemTemplate>
                                                              </asp:TemplateField>
                                                          </Columns>
                                                          <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                                              ...
                                              <tr>
                                                  <td class="style78" valign="top">Branch.</td>
                                                  <td class="style69" valign="top"><strong>
                                                      <asp:DropDownList ID="cbBranch" runat="server" AutoPostBack="True" DataSourceID="Branch" DataTextField="BranchLocation" DataValueField="BranchCode" Height="20px" Width="227px">
                                                      </asp:DropDownList>
                                                      </strong></td>
                                              </tr>
                                              <tr>
                                                  <td class="style78" valign="top">Store Name.</td>
                                                  <td class="style69" valign="top"><strong>
                                                      <asp:TextBox ID="txtStoreName" runat="server" style="text-align: left; margin-left: 0px;" ToolTip="Enter wholesale qty..." Width="227px"></asp:TextBox>
                                                      </strong></td>
                                              </tr>
                                              <tr>
                                                  <td class="style77" colspan="2" valign="top"><strong style="font-weight: 700">
                                                      <asp:Button ID="saveStoreLocation" runat="server" Text="Save" ToolTip="Save store location." Width="66px" />
                                                      &nbsp;<asp:Button ID="SearchStoreLocation" runat="server" Text="Search" ToolTip="Search for store location." Width="66px" />
                                                      &nbsp;<strong><asp:Button ID="CloseStoreLocation" runat="server" Text="Close" ToolTip="Click to close store location view." Width="66px" />
                                                      <asp:SqlDataSource ID="Branch" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT BranchCode, BranchLocation FROM HospitalBranch_tbl"></asp:SqlDataSource>
                                                      <asp:SqlDataSource ID="wholesaleds" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT StockLocationTable.StockLocationID, HospitalBranch_tbl.BranchLocation, StockLocationTable.StoreName FROM StockLocationTable INNER JOIN HospitalBranch_tbl ON StockLocationTable.BranchID = HospitalBranch_tbl.BranchCode"></asp:SqlDataSource>
                                                      <asp:SqlDataSource ID="wholesaleSearchds" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT StockLocationTable.StockLocationID, HospitalBranch_tbl.BranchLocation, StockLocationTable.StoreName FROM StockLocationTable INNER JOIN HospitalBranch_tbl ON StockLocationTable.BranchID = HospitalBranch_tbl.BranchCode WHERE (StockLocationTable.BranchID = @BranchID)">
                                                          <SelectParameters>
                                                              <asp:ControlParameter ControlID="cbBranch" Name="BranchID" PropertyName="SelectedValue" />
                                                          </SelectParameters>
                                                      </asp:SqlDataSource>
                                                      <asp:TextBox ID="StockID" runat="server" Visible="False" Width="36px" Wrap="False"></asp:TextBox>
                                                      </strong></strong></td>
                                              </tr>
                                          </table>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">Patient ID</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtConsultPID" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                    <asp:Button ID="btn_ConsultGet" runat="server" Text="Get" Width="106px" />
                            </td>
                            <td class="auto-style20">Consultation Fee</td>
                            <td class="auto-style17">
                    <asp:TextBox ID="txtConsultPFee" runat="server" ReadOnly="True" Width="200px"></asp:TextBox>
                                <asp:Label ID="lblPaid" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#003399" Text="NOT PAID" Visible="False"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Consultation Date</td>
                            <td class="auto-style26">
                                <telerik:RadDatePicker ID="ConsulDate" Runat="server" AutoPostBack="True" Culture="en-US" Width="200px">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                            ...
                            <td class="auto-style18">
                    <asp:Button ID="btn_ConsultNew" runat="server" Text="New" Width="106px" />
                    <asp:TextBox ID="txtConsultPDate" runat="server" ReadOnly="True" Visible="False" Width="20px"></asp:TextBox>
                            </td>
                            <td class="auto-style20">Consultating Doctor</td>
                            <td class="auto-style17">
                    <asp:DropDownList ID="DlistConsultPDoc1" runat="server" class="chosen-select" DataSourceID="SqlDataSource2" DataTextField="Employee Name" DataValueField="Employee Name" Width="200px">
                    </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Consulting ID</td>
                            <td class="auto-style26" colspan="2">
                    <asp:TextBox ID="txtConsultID" runat="server" ReadOnly="True" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style20" rowspan="2">Description</td>
                            <td class="auto-style17" rowspan="2">
                    <asp:TextBox ID="txtConsultPDescribe" runat="server" TextMode="MultiLine" Height="120px" Width="200px"></asp:TextBox>
                                <br />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Purpose</td>
                            <td class="auto-style26" colspan="2">
                    <asp:TextBox ID="txtConsultPPurpose" runat="server" Height="71px" TextMode="MultiLine" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="ConsultID" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="ConsultID" HeaderText="Consult ID" SortExpression="ConsultID" ReadOnly="True" />
                                        <asp:BoundField DataField="PatientID" HeaderText="Patient ID" SortExpression="PatientID" />
                                        <asp:BoundField DataField="PatientName" HeaderText="Patient Name" SortExpression="PatientName" />
                                        <asp:BoundField DataField="Doctor" HeaderText="Doctor" SortExpression="Doctor" />
                                        <asp:BoundField DataField="Purpose" HeaderText="Purpose" SortExpression="Purpose" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT tbl_Consultation.ConsultID, tbl_Consultation.PatientID, tbl_Consultation.PatientName, tbl_Consultation.Doctor, tbl_Consultation.Purpose, tbl_Consultation.Description, tbl_Consultation.Charges, HospitalBranch_tbl.BranchLocation, tbl_Consultation.ConsultDateTime FROM tbl_Consultation INNER JOIN HospitalBranch_tbl ON tbl_Consultation.HospitalBranch = HospitalBranch_tbl.BranchCode ORDER BY tbl_Consultation.SN DESC"></asp:SqlDataSource>
