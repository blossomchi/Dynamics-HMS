<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_hwylxabg" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="DRUG CATEGORY MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                    ...
                    <asp:Button ID="RegisterID" runat="server" Text="ADD DRUG CLASSES" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="DrugID" DataSourceID="ViewAll" GridLines="None" PageSize="30" ShowFooter="True" Width="1208px" AllowSorting="True">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="DrugID" HeaderText="Code" ReadOnly="True" SortExpression="DrugID" />
                          <asp:BoundField DataField="DrugName" HeaderText="Drug Classes" SortExpression="DrugName" />
                     ...
                     <asp:TemplateField>
                                      ...
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/Employee/images/good.png" Text="Edit" ToolTip="View"/>
                                  </ItemTemplate>
                                     </asp:TemplateField>
                          </Columns>
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugClassHeadTable.DrugID, DrugClassHeadTable.DrugName, DrugClassHeadTable.Description, Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.Surname AS Staff, DrugClassHeadTable.DateCreated FROM Employee_New_tbl INNER JOIN DrugClassHeadTable ON Employee_New_tbl.EmployeeCode = DrugClassHeadTable.CreatedBy ORDER BY DrugClassHeadTable.DrugName"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">Drug Code</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugCode" runat="server" Width="400px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td class="auto-style26" rowspan="3">
                                <asp:GridView ID="HeadGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="DrugID" DataSourceID="headDS" GridLines="Vertical" PageSize="2" style="font-size: 11px" Visible="False" Width="463px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="DrugID" HeaderText="Drug Code" ReadOnly="True" SortExpression="DrugID" />
                                        <asp:BoundField DataField="DrugName" HeaderText="Drug Classes" SortExpression="DrugName" />
                                    <asp:TemplateField>
                                          <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                ...
                                <asp:SqlDataSource ID="headDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugID, DrugName FROM DrugClassHeadTable"></asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Class Group Name</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugName" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Class Description</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugDescription" runat="server" Width="400px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:Button ID="btn_Consult" runat="server" Text="SUBMIT" />
                            &nbsp;
                    <asp:Button ID="btnSub" runat="server" Text="CREATE SUB CLASSES" />
                                &nbsp;&nbsp;&nbsp;</strong></td>
                            <td class="auto-style26">
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Select Head Class</td>
                            <td class="auto-style26">
                                              <asp:DropDownList ID="CBSubHead" runat="server" class="chosen-select" AutoPostBack="True" DataSourceID="SubHeadDS" DataTextField="DrugName" DataValueField="DrugID" Width="400px">
                                              </asp:DropDownList>
                            </td>
                            <td class="auto-style26" rowspan="3">
                                <asp:GridView ID="DetailGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SubDS" GridLines="Vertical" PageSize="4" style="font-size: 11px" Visible="False" Width="477px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="DrugSubID" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="DrugSubID" />
                                        <asp:BoundField DataField="DrugID" HeaderText="Drug Code" SortExpression="DrugID" />
                                        <asp:BoundField DataField="SubName" HeaderText="Sub Class Name" SortExpression="SubName" />
                                     <asp:TemplateField>
                                          <ItemTemplate>
                                      <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="False" 
                                          CommandName="Select" ImageUrl="~/Employee/images/good.png" Text="Edit" ToolTip="View"/>
                                ...
                                <asp:SqlDataSource ID="SubDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugID, SubName, DrugSubID FROM DrugClassSubHeadTable WHERE (DrugID = @DrugID)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="CBSubHead" Name="DrugID" PropertyName="SelectedValue" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Sub Head Class</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugSubName" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Sub Head Description</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDrugSubDescription" runat="server" Width="400px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">&nbsp;</td>
                    ...
                    <hr /></td>
                                  ...
                                  <tr>
                                      <td class="auto-style45">
                                          ...
                                          <asp:TextBox ID="InSubID" runat="server" Visible="False" Width="20px"></asp:TextBox>
                                          <asp:SqlDataSource ID="SubHeadDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DrugID, DrugName FROM DrugClassHeadTable"></asp:SqlDataSource>
                                      </td>
                                  </tr>
                                  </table>
                          </td>
