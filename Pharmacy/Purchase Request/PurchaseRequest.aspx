<%@ page language="VB" autoeventwireup="false" inherits="Manage_Accounting_Purchases_PurchaseRequest, App_Web_rftjehkx" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" 
 ...
 <span class="xr_s0" style="position: absolute; left:247px; top:34px;">
  <span class="style2" style="left: -161px; top: -23px; width: 615px;">SHEPHERD HOSPITAL</span>
                       ...
                       <asp:GridView ID="PendingView" 
                              runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <asp:SqlDataSource ID="PurchasesDS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" 
