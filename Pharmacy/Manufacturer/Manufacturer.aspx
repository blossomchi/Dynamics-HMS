<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_ukuaei0x" %>
             ...
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="MANAUFACTURER MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                    ...
                    <asp:Button ID="RegisterID" runat="server" Text="CREATE MANUFACTURER" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ViewAll" GridLines="None" PageSize="30" ShowFooter="True" Width="1208px">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="ManuID" HeaderText="Manufacturer ID" SortExpression="ManuID" />
                          <asp:BoundField DataField="ProductCatName" HeaderText="Product Name" SortExpression="ProductCatName" />
                          <asp:BoundField DataField="ManuName" HeaderText="Manufacturer" SortExpression="ManuName" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ManufacturerTable.SN, ManufacturerTable.ManuID, ProductCatTable.ProductCatName, ManufacturerTable.ManuName, Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.Surname AS Staff, ManufacturerTable.DateCreated FROM Employee_New_tbl INNER JOIN ManufacturerTable ON Employee_New_tbl.EmployeeCode = ManufacturerTable.CreatedBy INNER JOIN ProductCatTable ON ManufacturerTable.PCatID = ProductCatTable.PCatID ORDER BY ManufacturerTable.SN"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">Select Product</td>
                            <td class="auto-style26" colspan="3">
                    <asp:DropDownList ID="CBProductCat" runat="server" class="chosen-select" Width="400px" AutoPostBack="True" DataSourceID="ProDS" DataTextField="ProductCatName" DataValueField="PCatID">
                    </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Manufacturer Code</td>
                            <td class="auto-style26" colspan="3">
                    <asp:TextBox ID="txtManuCode" runat="server" Width="400px" ReadOnly="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Manaufacturer</td>
                            <td class="auto-style26" colspan="3">
                    <asp:TextBox ID="txtManuName" runat="server" Width="400px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <asp:Button ID="btn_Consult" runat="server" Text="SUBMIT" />
                            ...
                            <td class="auto-style20" rowspan="2">
                                <asp:SqlDataSource ID="ProDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT PCatID, ProductCatName FROM ProductCatTable"></asp:SqlDataSource>
                            </td>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="4">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="ManuID" ShowFooter="True" style="font-size: 13px" Width="1179px" PageSize="20">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="SN" HeaderText="SN" SortExpression="SN" ReadOnly="True" InsertVisible="False" />
                                        <asp:BoundField DataField="ManuID" HeaderText="Manufacturer ID" SortExpression="ManuID" ReadOnly="True" />
                                        <asp:BoundField DataField="ProductCatName" HeaderText="Product Name" SortExpression="ProductCatName" />
                                        <asp:BoundField DataField="ManuName" HeaderText="Manufacturer" SortExpression="ManuName" />
                                        <asp:BoundField DataField="Staff" HeaderText="Staff" SortExpression="Staff" ReadOnly="True" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ManufacturerTable.SN, ManufacturerTable.ManuID, ProductCatTable.ProductCatName, ManufacturerTable.ManuName, Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.Surname AS Staff, ManufacturerTable.DateCreated FROM Employee_New_tbl INNER JOIN ManufacturerTable ON Employee_New_tbl.EmployeeCode = ManufacturerTable.CreatedBy INNER JOIN ProductCatTable ON ManufacturerTable.PCatID = ProductCatTable.PCatID"></asp:SqlDataSource>
