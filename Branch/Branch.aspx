<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_eqpkd05b" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="BRANCH MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
                  
                    <asp:Button ID="RegisterID" runat="server" Text="CREATE BRANCH" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="BranchCode" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                      <AlternatingRowStyle BackColor="Gainsboro" />
                      <Columns>
                          <asp:BoundField DataField="SN" HeaderText="SN" InsertVisible="False" ReadOnly="True" SortExpression="SN" />
                          <asp:BoundField DataField="BranchCode" HeaderText="Branch Code" ReadOnly="True" SortExpression="BranchCode" />
                          <asp:BoundField DataField="BranchLocation" HeaderText="Branch Name" SortExpression="BranchLocation" />
                      <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton22" runat="server" CausesValidation="false" 
                                  CommandName="DeleteBranch" ImageUrl="~/Branch/images/del.png" Text="Delete" Tooltip="Delete" CommandArgument='<%#Eval("SN")%>'/>
                             </ItemTemplate>
                         </asp:TemplateField>
                      </Columns>
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SN, BranchCode, BranchLocation FROM HospitalBranch_tbl ORDER BY SN"></asp:SqlDataSource>
                    ...
                    <asp:TextBox ID="txtBranchCode" runat="server" Width="400px"></asp:TextBox>
                            </td>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="BranchCode" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="SN" HeaderText="SN" SortExpression="SN" ReadOnly="True" InsertVisible="False" />
                                        <asp:BoundField DataField="BranchCode" HeaderText="Branch Code" SortExpression="BranchCode" ReadOnly="True" />
                                        <asp:BoundField DataField="BranchLocation" HeaderText="Branch Name" SortExpression="BranchLocation" />
                                   <asp:TemplateField ShowHeader="False">
                             <ItemTemplate>
                                 <asp:ImageButton ID="ImageButton22" runat="server" CausesValidation="false" 
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SN, BranchCode, BranchLocation FROM HospitalBranch_tbl ORDER BY SN"></asp:SqlDataSource>
