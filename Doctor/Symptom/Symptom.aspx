<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_3lhkaj5y" %>
             ...
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="SYMPTOM MANAGEMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
                  
                    <asp:Button ID="RegisterID" runat="server" Text="CREATE SYMPTOM" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="SymptomName" HeaderText="Symptom" SortExpression="SymptomName" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SymptomTable.ID, SymptomTable.SymptomName, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], SymptomTable.DateCreated FROM SymptomTable INNER JOIN Employee_New_tbl ON SymptomTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">Symptom Name</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtSym" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">Employee Code</td>
                            <td class="auto-style17">
                    <asp:TextBox ID="txtEmCodee" runat="server" ReadOnly="True" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT SymptomTable.ID, SymptomTable.SymptomName, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], SymptomTable.DateCreated FROM SymptomTable INNER JOIN Employee_New_tbl ON SymptomTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
