<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_3p5mwyeq" %>
             ...
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="INVESTIGATION NAME"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          ...
                          &nbsp;<asp:Button ID="RegisterID" runat="server" Text="INV NAME" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ID" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="InvestigationName" HeaderText="Investigation" SortExpression="InvestigationName" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT InvestigationTable.ID, InvestigationTable.InvestigationName, InvestigationTable.Description, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], InvestigationTable.DateCreated FROM InvestigationTable INNER JOIN Employee_New_tbl ON InvestigationTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">INV Name</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtINVName" runat="server" Width="300px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">Employee</td>
                            <td class="auto-style17">
                    <asp:TextBox ID="txtEmpCodee" runat="server" ReadOnly="True" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style17" style="vertical-align: top">
                                NOTES</td>
                            <td class="auto-style19">
                    <asp:TextBox ID="txtNote" runat="server" Height="71px" TextMode="MultiLine" Width="300px"></asp:TextBox>
                            </td>
                            <td class="auto-style26">
                                &nbsp;</td>
                            <td class="auto-style26">
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT InvestigationTable.ID, InvestigationTable.InvestigationName, InvestigationTable.Description, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], InvestigationTable.DateCreated FROM InvestigationTable INNER JOIN Employee_New_tbl ON InvestigationTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
