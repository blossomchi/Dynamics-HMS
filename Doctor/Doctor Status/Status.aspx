<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_mclcaa35" %>
...
<!--[if !IE]>--><div class="xr_ap" id="xr_xri" style="width: 1290px; height: 1600px; clip: rect(0px, 1290px, 1600px, 0px);"><!--<![endif]-->
 ...
 <img class="xr_ap" src="login_htm_files/30.png" alt="" title="" style="left: 1094px; top: 136px; width: 70px; height: 37px;"/>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         style="width: 1212px; left: 32px; top: 207px; height: 52px; position: absolute;" 
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="DOCTOR'S STATUS"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td>
                  
                              <table id="AETB1" runat="server"  cellpadding="0" cellspacing="0" class="auto-style41" style="border-width: 1px; border-style: solid;  border-top-left-radius:20px; border-top-right-radius:20px; background-color: white; width: 1196px; height: 332px; font-size: 15px;">
                                  <tr>
                                      <td class="auto-style45"><table cellpadding="5" cellspacing="5" class="auto-style10" id="tbl-format-c" align="center" style="width: 1206px; height: 433px;">
                        <tr>
                            <td class="auto-style19">Doctor&#39;s ID</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtDocID" runat="server" Width="200px" ReadOnly="True"></asp:TextBox>
                            </td>
                            <td class="auto-style20">Status</td>
                            <td class="auto-style17">
                                <asp:DropDownList ID="Status" runat="server" class="chosen-select" Width="200px">
                        ...
                        <tr>
                            <td class="auto-style19">Start Date</td>
                            <td class="auto-style26">
                                <telerik:RadDatePicker ID="StartDate" Runat="server" AutoPostBack="True" Culture="en-US" Width="200px">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                            ...
                            <td class="auto-style20">End Date</td>
                            <td class="auto-style17">
                                <telerik:RadDatePicker ID="EndDate" Runat="server" AutoPostBack="True" Culture="en-US" Width="200px">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"  Runat="server"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                        ...
                        <tr>
                            <td class="auto-style19">From Time</td>
                            <td class="auto-style26">
                                <telerik:RadTimePicker ID="FromTimePicker" Runat="server" Width="200px">
                                </telerik:RadTimePicker>
                            </td>
                            <td class="auto-style20">To Time</td>
                            <td class="auto-style17">
                                <telerik:RadTimePicker ID="ToTimePicker" Runat="server" Width="200px">
                                </telerik:RadTimePicker>
                                <br />
                            </td>
                        </tr>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="4">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="ID" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="ID" HeaderText="ID" SortExpression="ID" ReadOnly="True" InsertVisible="False" />
                                        <asp:BoundField DataField="EmployeeCode" HeaderText="Staff Code" SortExpression="EmployeeCode" />
                                        <asp:BoundField DataField=" Employee Name" HeaderText=" Employee Name" SortExpression=" Employee Name" ReadOnly="True" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DoctorStatuseTable.ID, DoctorStatuseTable.EmployeeCode, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname + ' ' + Employee_New_tbl.MiddleName AS [ Employee Name], DoctorStatuseTable.StartDate, DoctorStatuseTable.EndDate, DoctorStatuseTable.Status FROM DoctorStatuseTable INNER JOIN Employee_New_tbl ON DoctorStatuseTable.EmployeeCode = Employee_New_tbl.EmployeeCode INNER JOIN AuthenticationTable ON Employee_New_tbl.EmployeeCode = AuthenticationTable.EmployeeCode WHERE (AuthenticationTable.UserName = @UserName)">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="AdminLabel" Name="UserName" PropertyName="Text" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
