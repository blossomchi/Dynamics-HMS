<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_ssn4x1kd" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="DOCTORS'S ADVICE"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
                  
                    <asp:Button ID="RegisterID" runat="server" Text="ENTER ADVICE" TabIndex="31" />
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="int" DataSourceID="ViewAll" GridLines="None" PageSize="20" ShowFooter="True" Width="1208px">
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DoctorAdviceTable.int, DoctorAdviceTable.Advice, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], DoctorAdviceTable.DateCreated FROM DoctorAdviceTable INNER JOIN Employee_New_tbl ON DoctorAdviceTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
                      ...
                      <tr>
                        ...
                        <tr>
                            <td class="auto-style19">Doctors Advice</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtAdviceName" runat="server" Width="200px"></asp:TextBox>
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">Employee Code</td>
                            <td class="auto-style17">
                    <asp:TextBox ID="txtEmpCodee" runat="server" ReadOnly="True" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="5">
                                <asp:GridView ID="grd_Consult" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="None" DataKeyNames="int" ShowFooter="True" style="font-size: 13px" Width="1179px">
                                    <AlternatingRowStyle BackColor="#DCDCDC" />
                                    <Columns>
                                        <asp:BoundField DataField="int" HeaderText="int" SortExpression="int" ReadOnly="True" InsertVisible="False" />
                                        <asp:BoundField DataField="Advice" HeaderText="Advice" SortExpression="Advice" />
                                        <asp:BoundField DataField="Entered By" HeaderText="Entered By" SortExpression="Entered By" ReadOnly="True" />
                                        <asp:BoundField DataField="DateCreated" HeaderText="Date Created" SortExpression="DateCreated" />
                                    </Columns>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT DoctorAdviceTable.int, DoctorAdviceTable.Advice, Employee_New_tbl.Surname + ' ' + Employee_New_tbl.Firstname AS [Entered By], DoctorAdviceTable.DateCreated FROM DoctorAdviceTable INNER JOIN Employee_New_tbl ON DoctorAdviceTable.EmployeeCode = Employee_New_tbl.EmployeeCode"></asp:SqlDataSource>
