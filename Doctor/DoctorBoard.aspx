<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_lseguqqn" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" >
                      <tr>
                          <td colspan="6">
                              ...
                              <strong><span class="auto-style11">DOCTOR DASHBOARD</span><hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton1" runat="server" Height="117px" ImageUrl="~/Doctor/images/doc.jpeg" Width="143px" ToolTip="Register In Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton11" runat="server" Height="97px" ImageUrl="~/Doctor/images/Symptom_Check.png" Width="130px" ToolTip="Create Symptom" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton12" runat="server" Height="97px" ImageUrl="~/Doctor/images/invastigation.png" Width="130px" ToolTip="Investigation Name" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton10" runat="server" Height="97px" ImageUrl="~/Doctor/images/advice-cloud.png" Width="130px" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton9" runat="server" Height="109px" ImageUrl="~/Doctor/images/precription.jpg" Width="144px" ToolTip="Booking Patient to see doctor" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton7" runat="server" Height="117px" ImageUrl="~/In Patient/Register/images/12.jpeg" Width="159px" ToolTip="Patient Admission" />
