<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_0eqnong5" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" >
                      <tr>
                          <td colspan="6">
                              ...
                              <strong><span class="auto-style11">LAB LAB TECHNICIAN DASHBOARD</span><hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton9" runat="server" Height="109px" ImageUrl="~/Lab/Lab Board/images/Register-512.png" Width="144px" ToolTip="Lab Registration" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton1" runat="server" Height="124px" ImageUrl="~/Lab/Lab Board/images/2357e3f46ec5f47.jpg" Width="148px" ToolTip="Lab Test" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton3" runat="server" Height="111px" ImageUrl="~/Doctor/images/people1.png" Width="134px" ToolTip="View Assigned Patient" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton7" runat="server" Height="117px" ImageUrl="~/In Patient/Register/images/no.png" Width="159px" ToolTip="Patient Admission" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton4" runat="server" Height="97px" ImageUrl="~/In Patient/Register/images/no.png" Width="130px" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton10" runat="server" Height="97px" ImageUrl="~/In Patient/Register/images/no.png" Width="130px" />
