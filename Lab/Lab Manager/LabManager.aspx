<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_fnsrlp0q" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-weight: 700; font-size: 16px;" Text="LAB MANAGEMENT"></asp:Label>
                          </td>
                          <td>
                      ...
                      <tr>
                          <td valign="Top">
                             ...
                             <fieldset class="auto-style25" style="border-style: solid;"><legend>Available Lab Tests</legend>
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_Clinical" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Clinical.aspx" Target="Test_View">Clinical Chemistry</asp:HyperLink>
                            ...
                            <tr>
                                <td class="auto-style30">
                                    ...
                                    <asp:HyperLink ID="HLnk_Hormonal" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Hormonal.aspx" Target="Test_View">Hormonal Assay</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style30">
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_Widal" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Widal.aspx" Target="Test_View">Widal Agglutination Tittres</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style31">
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_Haemogloby" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Haematology-BloodBanking.aspx" Target="Test_View">Haematology And Blood Banking</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style31">
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_Antibiotics" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Antibiotics.aspx" Target="Test_View">Antibiotics Sensitivity Pattern</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style31">
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_SeminalFluid" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Seminal_Fluid_Analysis.aspx" Target="Test_View">Seminal Fluid Analysis</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style31">
                            ...
                            <tr>
                                <td class="auto-style31">
                                    ...
                                    <asp:HyperLink ID="HLnk_Miscellanous" runat="server" ForeColor="Black" NavigateUrl="~/Lab/Lab Content/Lab_Content_Miscellanous.aspx" Target="Test_View">Miscellaneous Test</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style31">
                               ...
                               <tr>
                                <td class="auto-style31">
                                      ...
                                      <asp:LinkButton runat="server" ID="Lnk_View_Request" Text="View Lab Request"/>
                                </td>
                            </tr>      
                            </table>
                          ...
                          <td style="text-align: right">
                              ...
                              <iframe id="LabTes" name="Test_View" style="width: 998px; height: 1177px; background-color: #FFFFFF; border-top-style: ridge; border-left-style: ridge; border-top-width: 1px; border-left-width: 1px;"></iframe>
                          </td>
                      </tr>
                      </table> 
