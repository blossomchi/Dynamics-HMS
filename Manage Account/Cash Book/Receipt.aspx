<%@ page language="VB" autoeventwireup="false" inherits="Invoice, App_Web_faoied0s" %>
                        ...
                        <table id="ReceiptHeaderTable" runat="server" visible="True" 
                            ...
                            <tr>
                                <td class="style46" >
                                 ...
                                 <asp:Label ID="LBSalesPerson" runat="server">Patient ID:</asp:Label>
                            ...
                            <tr>
                                <td >
                                 ...
                                 <asp:Label ID="LBAccountNo1" runat="server">Patient Name :</asp:Label>
