<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_y1xno0al" %>
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" >
                      <tr>
                          <td colspan="6">
                              ...
                              <strong><span class="auto-style11">ACCOUNT DASHBOARD</span><hr />
                              </strong>
                      ...
                      <tr>
                          <td>
                              ...
                              <asp:ImageButton ID="ImageButton1" runat="server" Height="85px" ImageUrl="~/Manage Account/images/chart-of-accounts.jpg" Width="134px" ToolTip="Chart Of Accounts" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton3" runat="server" Height="85px" ImageUrl="~/Manage Account/images/cash book2.jpg" Width="134px" ToolTip="Cash Book" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton7" runat="server" Height="70px" ImageUrl="~/Manage Account/images/People-Patient-Male-icon.png" Width="132px" ToolTip="Patient Account" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton4" runat="server" Height="86px" ImageUrl="~/Manage Account/images/c2.jpeg" Width="136px" ToolTip="Consultation Fees" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton5" runat="server" Height="112px" ImageUrl="~/In Patient/Register/images/no.png" Width="127px" />
         

                          </td>
                          <td>
                  
                              <asp:ImageButton ID="ImageButton6" runat="server" Height="105px" ImageUrl="~/In Patient/Register/images/no.png" Width="134px" />
