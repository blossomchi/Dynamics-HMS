<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_klnzwbcw" %>
             ...
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="VIEW PATIENT ACCOUNT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                  ...
                  <asp:GridView ID="ViewAllRecords" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ViewAll" GridLines="None" PageSize="30" ShowFooter="True" Width="1208px">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="First Details" HeaderText="First Details" SortExpression="First Details" />
                          <asp:BoundField DataField="Second Details" HeaderText="Second Details" SortExpression="Second Details" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT PatientAccountTable.TransDate, RegistrationHeader_tbl.Surname + ' ' + RegistrationHeader_tbl.Firstname + ' ' + RegistrationHeader_tbl.Middlename AS [Patient Name], PatientAccountTable.Account, PatientAccountTable.AccountDetail AS [First Details], PatientAccountTable.AccountDetails AS [Second Details], PatientAccountTable.Amount, PatientAccountTable.TransactionType AS [Trans Type], PatientAccountTable.Remark, PatientAccountTable.DateCreated AS [Entry Date], PatientAccountTable.CreatedBy AS [Entered By] FROM RegistrationHeader_tbl INNER JOIN PatientAccountTable ON RegistrationHeader_tbl.PatientID = PatientAccountTable.PatientID ORDER BY PatientAccountTable.TransDate DESC"></asp:SqlDataSource>
