<%@ page language="VB" autoeventwireup="false" inherits="Employee, App_Web_3dy1nwcs" %>
    ...
    <table id="EmployeeTB" runat="server"  valign="top"
         ...
         <tr >
             <td class="auto-style9" style="position: ; text-align: left; " colspan="6"   >
                  ...
                  <table id="ViewStaffTB"  runat="server" valign="top" visible ="true" align="left" >
                      <tr>
                          <td>
                              ...
                              <asp:Label ID="Label16" runat="server" style="font-size: 18px; font-weight: 700" Text="CONSULTATION FEES PAYMENT"></asp:Label>
                          </td>
                      </tr>
                      <tr>
                          <td style="text-align: right">
                  
                    <asp:Button ID="RegisterID" runat="server" Text="MAKE PAYMENT" TabIndex="31" />
                  ...
                  <asp:SqlDataSource ID="ViewAll" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ConsultationPaymentTable.PatientID, RegistrationHeader_tbl.Surname + ' ' + RegistrationHeader_tbl.Firstname + ' ' + RegistrationHeader_tbl.Middlename AS [Patient Name], ConsultationPaymentTable.Purpose, ConsultationPaymentTable.Amount, ConsultationPaymentTable.ConsultDateTime FROM ConsultationPaymentTable INNER JOIN RegistrationHeader_tbl ON ConsultationPaymentTable.PatientID = RegistrationHeader_tbl.PatientID"></asp:SqlDataSource>
                    ...
                    <asp:TextBox ID="txtConsultPID" runat="server" Width="300px"></asp:TextBox>
                    <asp:Button ID="btn_ConsultGet" runat="server" Text="Check" Width="106px" />
                            </td>
                        ...
                        <tr>
                            <td class="auto-style19">Payment Date</td>
                            <td class="auto-style26">
                    <asp:TextBox ID="txtConsultPDate" runat="server" ReadOnly="True" Width="300px"></asp:TextBox>
                    <asp:Button ID="btn_ConsultNew" runat="server" Text="New" Width="106px" ToolTip="Refresh" />
                            </td>
                            <td class="auto-style18">
                                &nbsp;</td>
                            <td class="auto-style20">&nbsp;</td>
                    ...
                    <asp:TextBox ID="txtConsultPPurpose" runat="server" Height="71px" TextMode="MultiLine" Width="300px"></asp:TextBox>
                            </td>
                            <td class="auto-style20"></td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Consultation Fee</td>
                            <td class="auto-style26" colspan="2">
                    <asp:TextBox ID="txtConsultPFee" runat="server" Width="300px"></asp:TextBox>
                                </td>
                            <td class="auto-style20">
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td class="auto-style19">Payment Mode</td>
                            <td class="auto-style26" colspan="2">
                                <asp:DropDownList ID="CBPayment" runat="server" class="chosen-select" DataSourceID="PaymentDS" DataTextField="PaymentName" DataValueField="ID" Width="300px" AutoPostBack="True">
                                </asp:DropDownList>
                                </td>
                            <td class="auto-style20">
                                &nbsp;</td>
                            ...
                            <td class="auto-style19" colspan="4">
                                <table class="auto-style21" runat ="server" visible ="false" id="CardTB" >
                                    <tr>
                    ...
                    <asp:TextBox ID="txtCardNumber" runat="server" Width="300px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Holder" runat="server" Text="Holder Name"></asp:Label>
                                        </td>
                                        <td>
                    ...
                    <asp:TextBox ID="txtHolder" runat="server" Width="300px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type" runat="server" Text="Card Type"></asp:Label>
                                        </td>
                                        <td>
                                
                                <asp:DropDownList ID="CBCardType" runat="server"  class="chosen-select" Width="300px">
                                ...
                                <table class="auto-style21" runat ="server" visible ="false" id="ChequeTB" >
                                    <tr>
                                        <td class="auto-style22">
                                            &nbsp;</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type0" runat="server" Text="Cheque Number"></asp:Label>
                                        </td>
                                        <td>
                                
                                <strong>
                                <asp:TextBox ID="txtCheque" runat="server" style="text-align: left; margin-left: 0px;" Width="300px" Wrap="False"></asp:TextBox>
                                </strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type1" runat="server" Text="Bank"></asp:Label>
                                        </td>
                                        <td>
                                
                                <asp:DropDownList ID="CBChequeBank" runat="server" class="chosen-select"  DataSourceID="BankDS" DataTextField="Bank" DataValueField="ID" Width="300px">
                                </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type2" runat="server" Text="Date On Cheque"></asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadDatePicker ID="RadDatePicker1" Runat="server" AutoPostBack="True" Culture="en-US" Width="320px">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                                ...
                                <table class="auto-style21" runat ="server" visible ="false" id="BankTB" >
                                    <tr>
                                        <td class="auto-style22">
                                            &nbsp;</td>
                                        <td>
                                            ...
                                            <strong>
                                <asp:Label ID="Type7" runat="server"></asp:Label>
                                            </strong></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type4" runat="server" Text="Bank"></asp:Label>
                                        </td>
                                        <td>
                                
                                <asp:DropDownList ID="CBBank" runat="server" class="chosen-select"  DataSourceID="BankDS" DataTextField="Bank" DataValueField="ID" Width="300px">
                                </asp:DropDownList>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type6" runat="server" Text="Account Name"></asp:Label>
                                        </td>
                                        <td>
                                
                                            <strong>
                                            <asp:TextBox ID="txtCusAccountName" runat="server" style="text-align: left; margin-left: 0px;" Width="300px" Wrap="False"></asp:TextBox>
                                            </strong>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="auto-style22">
                                <asp:Label ID="Type5" runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadDatePicker ID="RadDatePicker2" Runat="server" AutoPostBack="True" Culture="en-US" Width="320px">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" ViewSelectorText="x"></Calendar>
                    ...
                    <hr /></td>
                        ...
                        <tr>
                            <td class="auto-style28" colspan="4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ConsultationPaymentTable.PatientID, RegistrationHeader_tbl.Surname + ' ' + RegistrationHeader_tbl.Firstname + ' ' + RegistrationHeader_tbl.Middlename AS [Patient Name], ConsultationPaymentTable.Purpose, ConsultationPaymentTable.Amount, ConsultationPaymentTable.ConsultDateTime FROM ConsultationPaymentTable INNER JOIN RegistrationHeader_tbl ON ConsultationPaymentTable.PatientID = RegistrationHeader_tbl.PatientID"></asp:SqlDataSource>
                                ...
                                <asp:SqlDataSource ID="PaymentDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ID, PaymentName FROM PaymentMethod"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="BankDS" runat="server" ConnectionString="<%$ ConnectionStrings:HMS_DBConnectionString %>" SelectCommand="SELECT ID, Bank FROM BankTable"></asp:SqlDataSource>
                            </td>
                        </tr>
                        </table></td>
                                  </tr>
